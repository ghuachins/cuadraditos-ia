...
(defun val_minimax (nodo)
	(let ((maximo -50) (minimo 50) (valor '()) (aux '()))
		;(format t "~%Nodo Padre: ~s Turno:~s Regla:~s Nivel:~s" (nth 0 nodo) (nth 1 nodo) (nth 2 nodo) (nth 3 nodo))
...
(defun feval (tablero turno)	
	...
	;f_eval=(0.5*(nro. de cuad. con 2 lineas)+0.8*(nro. de cuad. mios))-(0.2*(nro. de cuad. con 3 lineas)+0.2*(nro. de cuad. de adversario))
	;(if (= turno 1)
		(setq fun_eval (- (+ (* 0.5 num_cuad_2) (* 1.8 cnt1)) (+ (* 0.2 num_cuad_3) (* 0.2 cnt_1))))
		;(setq fun_eval (- (+ (* 0.5 num_cuad_2) (* 1.8 cnt_1)) (+ (* 0.2 num_cuad_3) (* 0.2 cnt1))))
	;)
